...
def process_csv_file(csv_file_path, source_type, base_release_date, collection_name="promises", dry_run=False):
...
def main():
    ...
    parser.add_argument('--collection_name', default='promises', help='Firestore collection name (default: promises_test)')
