...
| `dev_linking_status`        | String (nullable)   | Developer status for automated linking processes.                                                          | "pending_linking", "linked", "error"       | For news releases, set to "pending" initially.                                                                                              |
