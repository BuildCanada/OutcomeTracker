...
EVIDENCE_ITEMS_COLLECTION = "evidence_items" # Target evidence collection
...
async def process_pending_raw_oics(db_client, dry_run=False, output_to_json=False, json_output_dir=None, 
    ...
    try:
        ...
        for raw_oic_doc_snapshot in pending_oic_docs:
            ...
            title_preview = raw_oic_data.get('title_or_summary_raw') or ''
            logger.info(f"Processing raw OIC: {raw_oic_id} - Title: {title_preview[:50]}...")
            processed_count += 1
