    ...
    <div className="max-w-2xl">
      ...
      <div className="space-y-6">
        <div>
          ...
          <div className="text-gray-700 space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>
                <strong>Completed</strong>: the commitment appears to have been
                substantially delivered based on what is shown.
              </li>
              <li>
                <strong>Broken</strong>: the commitment no longer appears
                achievable as promised, or later action clearly moved away from
                it. Some commitments have specific dates attached to them. If
                that date passes without the commitment being completed, even if
                the government is still working on it, it is broken.
              </li>
            </ul>
            <p>
        ...
        <div>
          ...
          <div className="text-gray-700 space-y-4">
            <p>
              We proactively source public announcements by the government, bill
              status updates as they work their way through parliament,
            ...
            <p>
              ...
              <code>*.gc.ca</code> domains to see if we missed anything that was
              not in the feeds we track.
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-700">
            We have sourced commitments from the Liberal 2025 Election Platform,
            the Speech from the Throne, and the Fall Budget. We are exploring
            sourcing commitments from other public communications.
          </p>
        </div>
